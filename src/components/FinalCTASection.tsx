...
export const FinalCTASection = () => {
  return <section className="py-32 px-4 relative overflow-hidden bg-purple">
      {/* Background Image with Overlay */}
      <div className="absolute inset-0 z-0">
        <img src={skylineImage} alt="City skyline" className="w-full h-full object-cover opacity-20" />
        <div className="absolute inset-0 bg-gradient-to-b from-bg-dark/95 via-bg-dark/90 to-bg-dark/95 my-[98px]" />
      </div>
      <div className="container mx-auto max-w-4xl relative z-10">
        <div className="text-center space-y-6 md:space-y-8">
          <h2 className="md:text-5xl lg:text-6xl font-display font-bold leading-tight text-white text-2xl">
