...
export const FormSection = () => {
  ...
  return <section id="formulario" className="py-16 md:py-24 px-6 md:px-4 bg-white">
        ...
        <div className="glass-card p-6 md:p-12 glow-accent bg-white/50">
          <form onSubmit={handleSubmit} className="space-y-5 md:space-y-6">
            <div className="space-y-2">
              ...
              ...formData,
              name: e.target.value
            })} className="bg-background/50 border-border focus:border-accent h-12 md:h-11" required />
            </div>
            ...
            <div className="space-y-2">
              ...
              <Input id="city" type="text" placeholder="Sua cidade" value={formData.city} onChange={e => setFormData({
              ...formData,
              city: e.target.value
            })} className="bg-background/50 border-border focus:border-accent h-12 md:h-11" required />
            </div>
            ...
            <div className="space-y-2">
              ...
              <Input id="profession" type="text" placeholder="Sua profissão" value={formData.profession} onChange={e => setFormData({
              ...formData,
            ...
            <div className="space-y-2">
              ...
              <Input id="investment" type="text" placeholder="R$ 0.000,00" value={formData.investment} onChange={e => setFormData({
              ...formData,
              investment: e.target.value
            })} className="bg-background/50 border-border focus:border-accent h-12 md:h-11" />
            </div>

            <Button type="submit" size="lg" className="w-full btn-gradient transition-all duration-300 glow-accent md:text-lg md:py-7 group mt-6 py-0 my-[27px] text-xs text-center opacity-95">
